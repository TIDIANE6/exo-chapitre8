...
public class BookShelfSpec {
    ...
    void groupBooksInsideBookShelfByPublicationYear() {
        ...
        // test du cas du tri par date
    }
    @Test
    void booksAreSortedByPublicationDate() {
        BookShelf shelf = new BookShelf();

        Book book1 = new Book("Effective Java", "Joshua Bloch", LocalDate.of(2008, Month.MAY, 8));
        Book book2 = new Book("Clean Code", "Robert C. Martin", LocalDate.of(2008, Month.AUGUST, 1));
        Book book3 = new Book("Refactoring", "Martin Fowler", LocalDate.of(1999, Month.JULY, 8));

        shelf.add(book1, book2, book3);

        List<Book> sortedBooks = shelf.arrange((b1, b2) -> b1.getPublishedOn().compareTo(b2.getPublishedOn()));

        assertThat(sortedBooks)
                .containsExactly(book3, book1, book2); // du plus ancien au plus récent
    }
}
